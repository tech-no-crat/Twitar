...
describe User do
  ...
  before(:each) do
    @attr = { :name => "Example User", :email => "user@somewhere.com", :password => "secret", :password_confirmation => "secret" }
  end
  ...
  it "should reject invalid email addresses" do
    invalid_addresses = %w[user@somewhere,com user_at_somewhere.com rebecca.black@hell.]
  ...
  it "should reject duplicate email addresses" do
    User.create!(@attr)
    user_with_duplicate_email = User.new(@attr.merge(:name => "bob"))
    user_with_duplicate_email.should_not be_valid
  end

  it "should reject case-insensitve duplicate email addresses" do
  ...
  describe "password encryption" do
    ...
    describe "authenticate method" do
      ...
      it "should return nil for an email address with no user" do
        nonexistent_user = User.authenticate("noone@here.com", @attr[:password])
